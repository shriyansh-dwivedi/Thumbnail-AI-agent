...
with st.sidebar:
    ...
    api_key = st.text_input(
        ...
        type="password",
        help="Works without a key too. A free key (no card needed) from enter.pollinations.ai gives higher rate limits.",
    )
    st.markdown("[Get a free key →](https://enter.pollinations.ai) (optional)")
    st.divider()
