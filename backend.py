...
TEXT_MODEL = "openai-fast"  # confirmed free text model, used to write the image prompt
IMAGE_MODEL = "flux"        # free image model (negligible/0 Pollen cost)
...
def generate_full_thumbnail(api_key: str, topic: str, style: str = "Bold & Vibrant",
    ...
    if use_prompt_enhancer:
        try:
            ...
            # (rate limit, model pricing change, etc.), fall back quietly
            # instead of breaking the whole generation.
